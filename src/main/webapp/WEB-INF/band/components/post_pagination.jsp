...
<ul class="pagination justify-content-center" style="margin: 20px 0;">
    ...
    <c:choose>
        ...
        <c:otherwise>
            <li class="page-item"><a href="/band/post?id=${page-1}" class="page-link">Previous</a></li>
        </c:otherwise>
    </c:choose>
    ...
    <c:forEach var="i" begin="${begin}" end="${end}">
        <c:choose>
            ...
            <c:otherwise>
                <li class="page-item"><a href="/band/post?id=${i}" class="page-link">${i}</a></li>
            </c:otherwise>
        </c:choose>
    </c:forEach>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <li class="page-item"><a href="/band/post?id=${page+1}" class="page-link">Next</a></li>
        </c:otherwise>
    </c:choose>
</ul>
